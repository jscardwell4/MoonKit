      ...
      default:
        switch ((from.x, from.y), (to.x, to.y))
        {
          ...
          case let ((x1, y1), (x2, y2)) where x2 == x1 && y2 >= y1:
            ...
            {
              case .II,
                   .III: direction = .counterClockwise
              default: direction = .clockwise
            }
...
where U1: Packable2,
      ...
      U1.Unpackable2Element: BinaryNumeric
{
...
public extension CGFloat
{
  ...
  func rounded(_ mantissaLength: Int) -> CGFloat
  { return MoonKit
    .rounded(self, mantissaLength)
  }
}
