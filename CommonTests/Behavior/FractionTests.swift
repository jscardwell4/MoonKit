...
final class FractionTests: XCTestCase {
  ...
  func testSquareRoot() {
    ...
    expect(Double((12÷10).squareRoot())).to(equalWithAccuracy(1.2.squareRoot(), 0.1e-14))
    expect(Double((-(12÷10)).squareRoot())).to(equalWithAccuracy(-1.2.squareRoot(), 0.1e-14))
    expect(Double((12525÷100).squareRoot())).to(equalWithAccuracy(125.25.squareRoot(), 0.1e-13))
    expect(Double((4÷9).squareRoot())).to(equalWithAccuracy((4.0/9.0).squareRoot(), 0.1e-14))
  }
  ...
  func testInitializeWithDouble() {
    ...
    expect(Fraction(Double.signalingNaN).numerator) == 0
    expect(Fraction(Double.signalingNaN).denominator) == 1
